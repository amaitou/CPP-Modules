...
void ClapTrap::takeDamage(unsigned int amount)
{
	if (this->_health < 1)
	{
		std::cout << "ScavTrap " << this->_name <<  " cannot take damage because he is dead" << std::endl;
		return ;
	}
	...
	if (this->_health > 0)
	{
		std::cout << "ScavTrap " << this->_name <<  " has taken " << amount << " of damage" << std::endl;
		return ;
	}
	if (this->_health == 0)
		std::cout << "ScavTrap " << this->_name << " has taken " << amount << " of damage and died" << std::endl;
}
...
void ClapTrap::beRepaired(unsigned int amount)
{
	if (this->_health < 1)
	{
		std::cout << "ScavTrap " << this->_name << " cannot repair himself since he died" << std::endl;
		return ;
	}
	if (this->_energy < 1)
	{
		std::cout << "ScavTrap " << this->_name << " cannot repair himself since he has no energy left" << std::endl;
		return ;
	}
	this->_health += amount;
	std::cout << "ScavTrap " << this->_name << " repairs " << amount << " of health" << std::endl;
	this->_energy--;
}