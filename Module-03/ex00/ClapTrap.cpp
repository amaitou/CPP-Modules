...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/12/21 00:58:24 by amait-ou          #+#    #+#             */
/*   Updated: 2023/12/21 00:58:25 by amait-ou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::attack(const std::string& target)
{
	...
	{
		std::cout << "ClapTrap " << this->_name << " cannot attack because he run out of power" << std::endl;
		return ;
	}
...
void ClapTrap::takeDamage(unsigned int amount)
{
	if (this->_health < 1)
	{
		std::cout << "ClapTrap " << this->_name <<  " cannot take damage because he is dead" << std::endl;
		return ;
	}
	...
	if (this->_health == 0)
		std::cout << "ClapTrap " << this->_name << " has taken " << amount << " of damage and died" << std::endl;
}
...
void ClapTrap::beRepaired(unsigned int amount)
{
	if (this->_health < 1)
	{
		std::cout << "ClapTrap " << this->_name << " cannot repair himself since he died" << std::endl;
		return ;
	}
	if (this->_energy < 1)
	{
		std::cout << "ClapTrap " << this->_name << " cannot repair himself since he has no energy left" << std::endl;
		return ;
	}
	this->_health += amount;
	std::cout << "ClapTrap " << this->_name << " repairs " << amount << " of health" << std::endl;
	this->_energy--;
}